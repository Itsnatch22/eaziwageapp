create table public.payroll_integrations (
  ...
  constraint payroll_integrations_employer_live_id_fkey foreign KEY (employer_live_id) references employers (id),
...
create trigger trg_guard_deleted_employer_onboarding BEFORE INSERT on payroll_integrations for EACH row
