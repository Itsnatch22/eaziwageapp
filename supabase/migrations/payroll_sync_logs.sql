create table public.payroll_sync_logs (
  ...
  constraint payroll_sync_logs_employer_live_id_fkey foreign KEY (employer_live_id) references employers (id),
...
create trigger trg_guard_deleted_employer_onboarding BEFORE INSERT on payroll_sync_logs for EACH row
